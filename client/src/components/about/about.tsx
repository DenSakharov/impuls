...
function About() {
  ...
  <DialogContent dividers>
      ...
      <Typography gutterBottom>
        ...
        стейкхолдерами и проектировщиками больших систем, которые в формируют связанную модель данных по проекту, между ключевыми бизнес-процессами, архитектурой, проектным документам и требованиям.
        </Typography>
        <Typography gutterBottom>
