...
function About() {
  ...
  <DialogContent dividers>
      ...
      <Typography gutterBottom>
        ...
        стейкхолдерами и проектировщиками больших систем.  Которые формируют связанную модель данных системы,
        с инструментами нжиниринга требований и конфигураций, схем архитектуры и взаимосвязи между ключевыми бизнес-процессами в течении всего жизненного цикла, с возможностью автогенерации проектных документов.
        </Typography>
        <Typography gutterBottom>
